...
cl = LineClient(authToken='EKULFmHcMkmsgKrryXjb.Zy/mlNPm5pGtxW51XwL1AW.+MHL4H2hrwTRC4cIiWQlrEsPniUQphrFMIUixRWVduU=')
...
poll = LinePoll(cl)
call = cl
creator = ["u19f85bd36000114102c0f5e09861500b"]
owner = ["u19f85bd36000114102c0f5e09861500b"]
admin = ["ucd8f8c2e7a4ce4f8135f0e75c569756b","u19f85bd36000114102c0f5e09861500b"]
staff = ["ucd8f8c2e7a4ce4f8135f0e75c569756b","u19f85bd36000114102c0f5e09861500b"]
...
def help1():
    ...
    helpMessage1 = "🔑❂͜͡➣ " + key + " [🔰ZB~BOT☯t]\n" + \
                  ...
                  "🔑❂͜͡➣ " + key + "sᴘᴀᴍᴄᴀʟʟ:「ᴊᴜᴍʟᴀʜɴʏᴀ」\n" + \
                   ...
                   "「🔑]   ʙʏ: zhero bot「🔑] \n" + \
                   "  Creator:  line.me/ti/p/~mutiarixxx"
    ...
    try:
        ...
        if op.type == 5:
              if wait["autoAdd"] == True:
                  ...
                  cl.sendContact(op.param1, "u19f85bd36000114102c0f5e09861500b")
                     ...
                     return
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"「CREATOR BOT\nJangan Di Add Creatornya Manis」WiDi DuDuL") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
...
#===========BOT UPDATE============#
                        elif msg.text in ["cinta","Tagall","Desah","Emuach","Assalamualaikum","Pagi","Siang","Sore","Malam","Nah","All"]:
                               if wait["selfbot"] == True:
                                if msg._from in admin:
...
#=========== [ Add Sticker ] ============#                                            
                          ...
                          if msg._from in admin:
                             ...
                             cl.sendAudio(msg.to,'tts.mp3')
                             cl.sendMessage(msg)         
                             cl.sendMessage(msg.to,"Jika Ada Yg di Tanyakan Huhungi Staff Di atas😊😊")
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/~dng9491\nhttp://line.me/ti/p/dng9491")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               cl.sendMessage(msg.to, "╭══════════\n║⚫─[     DAFTAR HARGA     ]─⚫ \n║SELFBOT ONLY = 100K /BLN\n║2 ASSIST = 150K /BLN\n║5 ASSIST = 250K /BLN\n║10 ASSIST = 350K /BLN\n║\n║PROTECT ANTIJS\n║\n║2 BOT + ANTIJS = 300K /BLN\n║5 BOT + ANTIJS = 400K /BLN\n║10 BOT + ANTIJS = 550K /BLN\n║\n║═ই\═ANDA BERMINAT\n║ SILAHKAN ADD CONTACT \n║ DIBAWAH INI   \n║\n║http://line.me/ti/p/~dng9491\n║       TERIMA KASIH      \n║\n╰════════════")
